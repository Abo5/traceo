...
**ماذا يرى:** زرا تصدير: **matrix.xlsx** يتنزّل بأربع أوراق (المتطلبات / الحالات / المصفوفة / آخر النتائج) **بإخراج RTL صحيح** لأن لغة المشروع عربية، و**report.html** يفتح تقريراً قابلاً للطباعة بـ `dir=rtl` — يسلّمه نواف لممثل الجهة كدليل تغطية موقّع بالأدلة.

**خلف الكواليس:** `GET /v1/projects/{id}/exports/matrix.xlsx` (openpyxl، `rightToLeft` للأوراق) و`GET /v1/runs/{id}/report.html` — كلاهما يمر عبر مسار حجب الأسرار نفسه: لا مسار برمجي يوصل سراً إلى تصدير.

**FR:** FR-RPT-04/05/07 · **NFR:** NFR-SEC-03, NFR-USE-03
...
| 12 | تصدير Excel / HTML | 0.5 د | **14.5 د ✓** |
...
journey
    ...
    section التسليم
      ...
      تصدير Excel و HTML للعميل: 5: نواف
```
