...
**الإسناد متحفّظ عمداً:** تُنسب الحالة إلى المعيار الذي أنتج ربطها فقط. فحالة حدّية مشتقّة من مخطط الواجهة تُنسب إلى المعيار الذي أدخل تلك الواجهة في النطاق، لا إلى كل معيار قد تلامسه عرضاً — فتُقلّل المصفوفة من ادّعاء التغطية بدل أن تبالغ فيه. وفي وثيقة تذهب إلى عقد، الحقيقة غير المُدّعاة يمكن استدراكها، والادّعاء الكاذب لا يمكن.
