...
const ACTS: {
...
}[] = [
  {
    ...
    note: "Hover a pane to clear the glass in front of it.",
  },
  {
    id: 2,
    num: "02",
    ...
    body:
      "Evidence is the condition of admission. The cases that cite something discovery observed take on substance and enter the orbit; the three drifting in from above cite nothing — a password-strength policy, a two-factor timeout, a referral rule — and never become solid at all. A suite that asserts behaviour the application never claimed is worse than no suite at all.",
    note: "Nine retained. Three discarded, and reported as discarded. Hover any case to name it.",
  },
  {
    id: 3,
    num: "03",
    ...
    body:
      "Each case is executed in a browser against the running page: fields are filled, forms are submitted, responses are awaited. The verdicts settling over the orbit were observed happening — none of them is an estimate of how the application would probably behave.",
  ...
  },
  {
    ...
    note: "Select a failed case to review its brief, or resolve all three at once.",
  },
];
        ...
        >
          <div className={s.heroInner}>
            ...
            <p className={s.hint} data-testid="landing-hint">
              <span className={s.kbd}>Hover</span> the glass to clear it ·{" "}
              <span className={s.kbd}>drag</span> to turn
            </p>
          </div>
